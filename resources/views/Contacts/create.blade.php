...
<div class="fullBody">
    ...
    <div class="fullList">
        ...
        <div class="list">
            ...
            <input  type="text" name="phoneNumber" id="pn"> <br>
            <label> تلفن:</label><br>
            <input  type="text" name="phone" id="p"><br>
            <label>آدرس:</label><br>
            <textarea type="text" name="address" id="ad"></textarea>

        </div>
        <input type="submit" class="listButton" value="ثبت مخاطب">
    </div>
    </form>
</div>
